...
import com.example.kinogid.presentation.main.lists.dialogs.MovieSelectorDialogFragment
    ...
    private fun showEditDialog(view: View, type: Int) {
        ...
        if (type == 1){
            ...
            MaterialAlertDialogBuilder(requireContext(), R.style.DialogTheme)
                ...
                .setView(inputField)
                .setBackground(ColorDrawable(ContextCompat.getColor(requireContext(),
